function loadAllFavoritePokemonsBigHtml(id) {
    const pokemonBiggerEl = document.querySelector('.favorite-show');
            ...
            <div class="main-slider">
              ...
              <div class="pokemon-arrow-heart">
                ...
                <svg onclick="addOrRemovePokemonToFavorite(${id})" class="icon-heart" data-id="${id}">
                  <use href="assets/icons/heart-red.svg#Layer_1"></use>
                </svg>
              </div>
                ...
                <section class="about-section" data-id="${id}">
                  ...
                  <dl class="about-dl">
                    ...
                    <div class="gender-info">
                      ...
                      <dd><img src=".assets/cons/gender-male.svg" alt=""></dd>
