    ...
    pokemonBiggerEl.innerHTML += /*html*/ `
            <div class="main-slider">
              ...
              <div class="pokemon-arrow-heart">
                <img class="icon-arrow" onclick="closeImage(event)" src="./icons/arrow-narrow-left.svg" alt="heart-regular">
                <img class="icon-heart" src="./icons/heart-regular.svg" alt="heart-regular">
              </div>
              ...
              <div id="left-icon" class="nav-arrow-single" onclick="toLeft(${id})">
                ...
                <ul class="pokemon-navbar" data-id="${id}">
                  <li class="pokemon-nav-item about-nav-item active" data-id="${id}" onclick="showSection('${id}','about-section')">
                    <a href="javascript:void(0)" class="text-decoration-none about-nav-item-a active-a" data-id="${id}">About</a>
                  </li>
                  <li class="pokemon-nav-item description-nav-item" data-id="${id}" onclick="showSection('${id}','description-section')">
                    <a href="javascript:void(0)" class="text-decoration-none description-nav-item-a" data-id="${id}">Description</a>
                  </li>
                  <li class="pokemon-nav-item languages-nav-item" data-id="${id}" onclick="showSection('${id}','pokemon-languages')">
                    <a href="javascript:void(0)" class="text-decoration-none languages-nav-item-a" data-id="${id}">Languages</a>
                  </li>
                  <li class="pokemon-nav-item stats-nav-item" data-id="${id}" onclick="showSection('${id}','pokemon-stats')">
                    <a href="javascript:void(0)" class="text-decoration-none stats-nav-item-a" data-id="${id}">Base stats</a>
                  </li>
                  <li class="pokemon-nav-item evolution-nav-item" data-id="${id}" onclick="showSection('${id}','pokemon-evolution')">
                    <a href="javascript:void(0)" class="text-decoration-none evolution-nav-item-a" data-id="${id}">Evolution</a>
                  </li>
                  <li class="pokemon-nav-item moves-nav-item" data-id="${id}" onclick="showSection('${id}','pokemon-moves')">
                    <a href="javascript:void(0)" class="text-decoration-none moves-nav-item-a" data-id="${id}">Moves</a>
                  </li>
                  <li class="pokemon-nav-item growth-rate-nav-item" data-id="${id}" onclick="showSection('${id}','growth-rate')">
                    <a href="javascript:void(0)" class="text-decoration-none growth-rate-nav-item-a" data-id="${id}">Growth rate</a>
                  </li>
                  <li class="pokemon-nav-item other-pictures-nav-item" data-id="${id}" onclick="showSection('${id}','other-pictures')">
                    <a href="javascript:void(0)" class="text-decoration-none other-pictures-nav-item-a" data-id="${id}">Pictures</a>
                  </li>
                </ul>
                <div id="right-icon" class="nav-arrow-single" data-id="${id}" onclick="toRight(${id})">
                  <a href="javascript:void(0)"><img class="nav-arrow" src="./icons/nav-arrow-right.svg" alt="right-icon"/> </a>
                </div>
              </div>
