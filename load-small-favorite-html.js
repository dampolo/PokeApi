function loadSmallFavoriteHtml(id, content, i) {
    ...
    pokemonImgContent.setAttribute('onclick', `favoriteRenderPokemonInfo(${id}, ${i})`);

    const smallLoaderImgContent = document.createElement('div');
    smallLoaderImgContent.className = 'small-loader-content';

    const smallLoaderImg = document.createElement('div');
    smallLoaderImg.className = 'small-loader';
    ...
    pokemonImgContent.appendChild(smallLoaderImgContent)
    smallLoaderImgContent.appendChild(smallLoaderImg)
